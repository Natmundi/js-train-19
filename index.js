...
// Зробимо щоб 'info' не можно було видалити або змінити, перевіримо і спробуємо присвоїти ій будь яке значconення (це потрібно робити ззовні defineProperty),
...
(Song.artist = "Загальний Виконавець"),
  ...
  (Song.play = function () {
    console.log(`Співає ${this.artist} таку ${this.title}`);
  });
